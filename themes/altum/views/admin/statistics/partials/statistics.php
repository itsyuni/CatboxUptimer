...
<div class="card mb-5">
    <div class="card-body">
        <h2 class="h4"><i class="fa fa-fw fa-chart-line fa-xs text-muted"></i> <?= language()->admin_statistics->statistics->header ?></h2>
        <div class="d-flex flex-column flex-xl-row">
            <div class="mb-2 mb-xl-0 mr-4">
                <span class="font-weight-bold"><?= nr($data->total['statistics']) ?></span> <?= language()->admin_statistics->statistics->chart ?>
            </div>
        </div>
...
<script>
    ...
    new Chart(statistics_chart, {
        ...
        data: {
            ...
            datasets: [
                {
                    label: <?= json_encode(language()->admin_statistics->statistics->chart) ?>,
