...
<div class="card my-3">
    <div class="card-body">
        ...
        <p class="text-muted mb-3"><?= language()->status_page_statistics->statistics->device_help ?></p>
            ...
            <div class="mt-4">
                <div class="d-flex justify-content-between mb-1">
                    <div class="text-truncate">
                        ...
                        <?php else: ?>
                            <span><?= language()->status_page_statistics->statistics->{'device_' . $row->device_type} ?></span>
                        <?php endif ?>
                    </div>
